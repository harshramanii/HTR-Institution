...
import { othersSubmitForm } from "../../actions/authAction";
...
const OtherForm = ({ navigation }) => {
  ...
  const onPressSubmit = () => {
    if (isEmpty(name)) {
      ...
      formData.append("comment", description?.trim()?.toLowerCase());
      ...
      dispatch(othersSubmitForm(request));
    }
  };
